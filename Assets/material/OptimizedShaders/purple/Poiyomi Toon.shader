Shader "Hidden/Locked/.poiyomi/Old Versions/9.2/Poiyomi Toon/a4b605bdc885f9747b986561fa3dd8f5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.5438906,0,1,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.5438906,0,1,1).a;
				#else
