Shader "Hidden/Locked/.poiyomi/Old Versions/9.2/Poiyomi Toon/70a4c05b8182dfb4ea8d8ddc4a7ad180"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,0,0.02037107,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(1,0,0.02037107,1).a;
				#else
